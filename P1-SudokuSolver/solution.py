...
# Used for Diagonal Sudoku
forward_diagonal_units = [[r+c for r, c in zip(rows, cols)]]
backward_diagonal_units = [[r+c for r, c in zip(rows, reversed(cols))]]

unitlist = row_units + column_units + square_units + forward_diagonal_units + backward_diagonal_units
